 ...
 * <pre/>
 */
package com.yuntongxun.xwork.dynamic.datasource.spring.boot.autoconfigure.hikari;
...
public class HikariCpConfig {
    ...
    public HikariConfig toHikariConfig(HikariCpConfig g) {
        ...
        Properties tempHealthCheckProperties = o(healthCheckProperties, g.getHealthCheckProperties());
    ...
    private <T>T o(T src, T defaultValue){
